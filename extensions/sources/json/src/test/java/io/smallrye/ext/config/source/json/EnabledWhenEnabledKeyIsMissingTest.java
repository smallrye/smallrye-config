 ...
 */
package io.smallrye.ext.config.source.json;
...
public class EnabledWhenEnabledKeyIsMissingTest {
    ...
    public static WebArchive createDeployment() {
        ...
        return ShrinkWrap.create(WebArchive.class, "JsonConfigSourceTest.war")
                .addPackage(JsonConfigSource.class.getPackage())
                ...
                .addAsResource(DisabledWhenEnabledKeyIsFalseTest.class.getClassLoader().getResource("config-empty.properties"), "META-INF/microprofile-config.properties")
