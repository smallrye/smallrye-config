...
public class ZooKeeperConfigSource implements ConfigSource {
    ...
    private static final String IGNORED_PREFIX = "io.smallrye.config.source.zookeeper";

    //Property the URL of the Zookeeper instance will be read from
    private static final String ZOOKEEPER_URL_KEY = "io.smallrye.config.source.zookeeper.url";

    //Property of the Application Id. This will be the root znode for an application's properties
    private static final String APPLICATION_ID_KEY = "io.smallrye.config.source.zookeeper.applicationId";

    //Name of this ConfigSource
    private static final String ZOOKEEPER_CONFIG_SOURCE_NAME = "io.smallrye.config.source.zookeeper";
