...
mvn -ntp build-helper:parse-version versions:set -DnewVersion=3.1.2-SNAPSHOT
find examples -maxdepth 1 -type d | xargs -I{} mvn -ntp -pl {} build-helper:parse-version versions:set -DnewVersion=3.1.2-SNAPSHOT
