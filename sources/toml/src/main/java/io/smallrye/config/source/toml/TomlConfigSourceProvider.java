...
public class TomlConfigSourceProvider extends AbstractLocationConfigSourceLoader implements ConfigSourceProvider {
    ...
    public List<ConfigSource> getConfigSources(final ClassLoader classLoader) {
        ...
        sources.addAll(loadConfigSources("META-INF/microprofile-config.toml", 105, classLoader));
        sources.addAll(loadConfigSources("WEB-INF/classes/META-INF/microprofile-config.toml", 105, classLoader));
        return sources;
    }
}
