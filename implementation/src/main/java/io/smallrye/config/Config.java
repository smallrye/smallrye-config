...
public interface Config extends org.eclipse.microprofile.config.Config {
     ...
     * @see Config#getValues(String, Converter, IntFunction)
     * @see Config#getOptionalValues(String, Class)
     * @see Config#getOptionalValues(String, Class, IntFunction)
     * @see Config#getOptionalValues(String, Converter, IntFunction)
     */
    @Override
     ...
     *         an empty string, or the converter returns {@code null}
     *
     * @see Config#getValues(String, Converter, Converter)
     * @see Config#getValues(String, Converter, Converter, IntFunction)
     * @see Config#getOptionalValues(String, Class)
     * @see Config#getOptionalValues(String, Class, IntFunction)
     * @see Config#getOptionalValues(String, Converter, IntFunction)
     */
     ...
     * <p>
     * Results in a {@code Map} with the entries {@code 200=OK}, {@code 201=CREATED}, and {@code 404=NOT_FOUND},
     * considering the configuration name as {@code server.reasons} and {@linkplain Converters Converters} to convert
     * the key type as an {@code Integer} and the property type as a {@code String}.
     * <p>
     * Otherwise, the configuration value is a single element represented by key value pairs as
     * {@code <key1>=<value1>;<key2>=<value2>...} separated by a semicolon {@code ;} with the backslash ({@code \}) as
     * the escape character.
     ...
     *         an empty string, or the converter returns {@code null}
     *
     * @see Config#getValues(String, Converter, Converter, IntFunction, IntFunction)
     * @see Config#getOptionalValues(String, Class, Class, IntFunction)
     * @see Config#getOptionalValues(String, Converter, Converter, IntFunction, IntFunction)
     */
     ...
     *         an empty string, or the converter returns {@code null}
     *
     * @see Config#getValue(String, Converter)
     * @see Config#getOptionalValue(String, Class)
     * @see Config#getOptionalValue(String, Converter)
     */
    @Override
     ...
     * and split into multiple elements with the backslash ({@code \}) as the escape character.
     * A configuration of {@code my.property=dog,cat,turtle} results in an array with the elements
     * {@code dog}, {@code cat}, and {@code turtle}, considering the configuration name as {@code my.property} and
     * the {@link Converter} to convert the property type as a {@code String}.
     * <p>
     * The indexed property format has priority when both styles are found in the same configuration source. When
     * available in multiple sources, the higher ordinal source wins, like any other configuration lookup.
     *
     ...
     *         an empty string, or the converter returns {@code null}
     *
     * @see Config#getOptionalValues(String, Converter, Converter)
     * @see Config#getOptionalValues(String, Converter, Converter, IntFunction)
     * @see Config#getValues(String, Class, Class)
     * @see Config#getValues(String, Converter, Converter)
     * @see Config#getValues(String, Converter, Converter, IntFunction)
     */
     ...
     * <br>
     * Because {@link ConfigSource#getPropertyNames()} may not include all
    ...
    /**
     * Return the currently registered {@linkplain ConfigSource configuration sources}
     ...
     * manner. The {@link Iterable} contains a fixed number of {@linkplain ConfigSource configuration sources},
     * determined at configuration initialization, and the config sources themselves may be static or dynamic.
     *
    ...
    /**
     * Return the first registered {@linkplain ConfigSource configuration sources}
     ...
     * @return an {@link Optional} of a {@linkplain ConfigSource}, or an empty {@link Optional} if
     *         no {@linkplain ConfigSource} matches the specified name.
     */
    Optional<ConfigSource> getConfigSource(String name);

    /**
     * Return the {@link Converter} used by this instance to produce instances of the specified type
     ...
     * @throws IllegalArgumentException if no {@link Converter} is registered for the specified type
     */
