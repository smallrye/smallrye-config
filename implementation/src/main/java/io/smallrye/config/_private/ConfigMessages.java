...
public interface ConfigMessages {
    ...
    @Message(id = 52, value = "Access to %2$s was denied in a modular environment. To avoid this error, edit "
    ...
    @Message(id = 53, value = "Access to %1$s was denied in a mixed-module environment. To avoid this error, "
    ...
    @Message(id = 54, value = "Missing a valid constructor on configuration implementation %s")
    IllegalStateException noConstructor(Class<?> implClass);

    @Message(id = 55, value = "The accessor for a configuration property is not valid")
