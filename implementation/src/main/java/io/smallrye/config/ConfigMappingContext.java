...
public final class ConfigMappingContext {
    ...
    void reportUnknown(final PropertyNamesMatcher<?> ignores) {
        ...
        for (String propertyName : config.getPropertyNames()) {
            if (ignores.matches(propertyName) || usedProperties.contains(propertyName)) {
                continue;
            }
    ...
    public class ObjectCreator<T> {
                        ...
                        if (unnamedKey != null) {
                            ...
                            nestedCreators.add(new Consumer<>() {
                                ...
                                public void accept(Function<String, Object> get) {
                                    ...
                                    if (value != null
                                            && (resolvedNonDefault
                                                    || unnamedDefaultInstance == null
                                                    || !value.equals(unnamedDefaultInstance))) {
        ...
        private static <V> V convertValue(
            ...
            if (configValue.getConfigSourceOrdinal() > Integer.MIN_VALUE) {
        ...
        private static <V> Optional<V> convertOptionalValue(
            ...
            context.usedProperties.add(propertyName);
            ConfigValue configValue = context.config.getConfigValue(propertyName);
            if (configValue.getValue() != null && configValue.getConfigSourceOrdinal() > Integer.MIN_VALUE) {
                context.resolvedNonDefault = true;
            }
